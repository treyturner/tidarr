...
| -------------- | -------------- | --------- | ---------------------------------- |
| `[FLAC 24bit]` | hires_lossless | `max`     | Tidal reports hi-res for the album tracks and `LIDARR_DISABLE_MAX_RESULTS` is not `true` |
